    ...
    <div class="main">
        <?php
            ...
            if(isset($_SESSION["answer"])) 
            {
                ...
                {
                    $answer = "";
                    $stmt= $pdo -> query("select * from exam_audio where category_title= '$_SESSION[exam_category]' && question_no=$i");
            ...
            $count = 0;
            $stmt2 = $pdo -> query("select * from exam_audio where category_title= '$_SESSION[exam_category]'");
...
<?php
    if(isset($_SESSION["exam_start"]))
    {
        ...
        values ('$_SESSION[username]', '$_SESSION[exam_category]', '$count', '$correct', '$wrong', '$date')");
    }

...
<body>
    ...
    <?php
    $insert = "insert into exam_results (username, exam_type, total_question, correct_answer, wrong_answer) 
            values ('$_SESSION[user_username]', '$_SESSION[quiz_level]', '$count', '$correct', '$wrong')";

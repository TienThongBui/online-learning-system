                            ...
                            <div class="col-md-9 col-lg-8 mx-auto">
                                ...
                                <div class="row text-center">
                                    ...
                                    if (isset($_GET['error'])) {
                                        ...
                                        <strong>Warning!</strong> Please fill in all fields!
                                            ...
                                            echo "<div class='alert alert-warning'>
                                        <strong>Warning!</strong> Choose proprt username!
                                      </div>";
                                        } elseif ($_GET["error"] == "invalidEmail") {
                                            // echo "<p>Choose proper email</p>";
                                            echo "<div class='alert alert-warning'>
                                        <strong>Warning!</strong> Choose proper email!
                                      </div>";
                                        } elseif ($_GET["error"] == "passwordnotMatch") {
                                            // echo "<p>Your password do not match</p>";
                                            echo "<div class='alert alert-warning'>
                                        <strong>Warning!</strong> Your password do not match!
                                      </div>";
                                        ...
                                        <strong>Warning!</strong> You are free to login! Enjoy!
                                      </div>";
                                        }
                                    }
                                    ?>
                                ...
                                <form action="../includes/registration.inc.php" method="post">
                                    ...
                                    <div class="d-grid">
                                        ...
                                        <div class="text-center">
                                            Already have an account? <a class="small" href="login.php"><b>Login</b></a>
                                        </div>
                                    </div>

...
<script type="text/javascript">
    ...
    function load_total_listening_quiz() 
    {
        ...
        xmlhttp.open("GET","../forajax/load_total_listening_quiz.php", true);
        xmlhttp.send(null);
    }


    var questionNo="1";
    load_listening_questions(questionNo);

    function load_listening_questions(questionNo)
    {
       document.getElementById("current_quiz").innerHTML=questionNo;
        ...
        xmlhttp.onreadystatechange=function() {
            if(xmlhttp.readyState==4 && xmlhttp.status==200) {
              ...
              {
                window.location="../result/listening_result.php";
              }
              else
              {
                document.getElementById("load_questions").innerHTML=xmlhttp.responseText;
                load_total_listening_quiz();
              }

            }
        };
        xmlhttp.open("GET","../forajax/load_listening_quiz.php?questionNo="+questionNo, true);
        xmlhttp.send(null);
    }

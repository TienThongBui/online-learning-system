...
if (isset($_POST["submit"])) {
        ...
        if (invalidUsername($username) !== false) {
                header("location: ../user/registration.php?error=invalidUsername");
                die();
        }
        ...
        if (passwordMatch($password, $repassword) !== false) {
                header("location: ../user/registration.php?error=passwordnotMatch");
                die();
        }
        if (usernameExsist($conn, $username, $username) !== false) {
                header("location: ../user/registration.php?error=usernameTaken");
                die();
        }

...
<head>
    ...
    <title>Admin PDF Lecttuce</title>
...
<body>
    ...
    <div class="main">
        <h2 class="text-center">Add new pdf Lecttuce</h2>
        <br>
        <div class="cotainer">
            <div class="row mb-5">
                <div class="col">
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="edit_pdf_lecttuce.php?id=<?php echo $lecttuces_id ?>"><i
                                        class="fa-solid fa-pen-to-square"></i></a>
                            </td>
                            <td>
                                <a href="delete_pdf_lecttuce.php?id=<?php echo $lecttuces_id ?>"><i

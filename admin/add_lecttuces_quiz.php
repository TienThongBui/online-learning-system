...
<body>
            ...
            <div class="row mb-5">
                <div class="col">
                    <div class="card">
                            ...
                            <strong>Add new quiz for <span class="text-danger"><?php echo $lecttuces_name ?></span></strong>
                        </div>
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="edit_lecttuces_quiz.php?qid=<?php echo $qid ?>"><i
                                        class="fa-solid fa-pen-to-square"></i></a>
                            </td>
                            <td>
                                <a href="delete_lecttuces_quiz.php?qid=<?php echo $lecttuces_id ?>"><i
    ...
    if (isset($_POST['submit'])) {
        ...
        $opt4 = $_POST['opt4'];
        $answer = $_POST['answer'];
        $query = "insert into lecttuces_quiz (quiz_no, lecttuces_id, quiz_name, opt1, opt2, opt3, opt4, answer) values
            ('$quiz_no','$lecttuces_id','$quiz_name','$opt1','$opt2','$opt3','$opt4','$answer')";
        $result = mysqli_query($conn, $query);
